This repo contains all the information, configuration, and scripts required/used for building https://github.com/AtlasOfLivingAustralia projects on [travis-ci.org](https://travis-ci.org).  
